function broughsz130 = importTXT(filename, startRow, endRow)
%IMPORTFILE1 Import numeric data from a text file as a matrix.
%   BROUGHSZ130 = IMPORTFILE1(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   BROUGHSZ130 = IMPORTFILE1(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   broughsz130 = importfile1('b_rough_sz_1_30.txt', 3, 115353);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/04/24 15:12:08
...
broughsz130 = table(dataArray{1:end-1}, 'VariableNames', {'x','y','z','bx','by','bz'});
