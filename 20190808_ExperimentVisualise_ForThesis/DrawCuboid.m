% Nicholas M, Updated 27 Oct 2010
% https://www.mathworks.com/matlabcentral/fileexchange/25559-draw-cuboid
% Accessed: 29/05/2019
...
SL = [10;10;5];   CV = [0;30;0];   EA = [0;0;0];   colr = [0.5 0.5 0.5];   alph = 0.5;
